...
class Dataset(torch.utils.data.Dataset):
    def __init__(self,
        ...
        max_size    = None,     # Artificially limit the size of the data. None = no limit. Applied before xflip.
        use_labels  = False,    # Enable conditioning labels? False = label dimension is zero.
        xflip       = False,    # Artificially double the size of the data via x-flips. Applied after max_size.
